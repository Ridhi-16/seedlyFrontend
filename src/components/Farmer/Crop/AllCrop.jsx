                                ...
                                < table className="table border">
                                  ...
                                  <h5> {el?.farmerId?.name}</h5>
                                                ...
                                                <td >
                                                    ...
                                                    <button className="btn" onClick={() => { deleteCrop(el?._id) }}><i class="fa fa-trash" aria-hidden="true"></i></button>
                                                    <Link to={`/farmer/crop/update/${el._id}`} className="btn btn-success mx-2"> <i className="fa fa-edit"></i></Link>
                                                </td>
                                            </tr>
                                        ))}
