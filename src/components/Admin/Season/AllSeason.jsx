                                            ...
                                            {season?.map((el, index) => (
                                                <tr key={index}>
                                                    ...
                                                    <td >
                                                        ...
                                                        <button className="btn" onClick={() => { deleteSeason(el?._id) }}><i className="fa fa-trash" aria-hidden="true"></i></button>
                                                        <Link to={`/admin/season/update/${el._id}`} className="btn btn-success mx-2"> <i className="fa fa-edit"></i></Link>
                                                    </td>
                                                </tr>
                                            ))}
